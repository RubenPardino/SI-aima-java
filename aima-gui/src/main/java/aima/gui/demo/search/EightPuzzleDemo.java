...
//		eightPuzzleAStarWeigthedMisplacedDemo();
//		eightPuzzleAStarWeigthedManhattanDemo();
		
		//heurístico no consistente
//		eightPuzzleAStarWeigthedNonConsistentDemo();
		
		//usando PEA*
		eightPuzzleAStarEpsilonWeigthedManhattanDemo();
...
//	}
	...
	private static void eightPuzzleAStarWeigthedManhattanDemo() {
		System.out.println("\nEightPuzzleDemo AStar Search (ManhattanWeigthedHeursitic)");
		try {
			Problem<EightPuzzleBoard, Action> problem = new BidirectionalEightPuzzleProblem(random1);
			SearchForActions<EightPuzzleBoard, Action> search = new AStarSearch<>
	...
	private static void eightPuzzleAStarEpsilonWeigthedManhattanDemo() {
		...
		try {
			Problem<EightPuzzleBoard, Action> problem = new BidirectionalEightPuzzleProblem(random1);
			SearchForActions<EightPuzzleBoard, Action> search = new AStarSearch<>
					(new GraphSearch<>(), EightPuzzleFunctions::getEpsilonWeigthedManhattanDistance);
			SearchAgent<Object, EightPuzzleBoard, Action> agent = new SearchAgent<>(problem, search);
			printActions(agent.getActions());
			printInstrumentation(agent.getInstrumentation());
		} catch (Exception e) {
...
//	}
	...
	private static void eightPuzzleAStarWeigthedMisplacedDemo() {
		...
		try {
			Problem<EightPuzzleBoard, Action> problem = new BidirectionalEightPuzzleProblem(random1);
			SearchForActions<EightPuzzleBoard, Action> search = new AStarSearch<>
					(new GraphSearch<>(), EightPuzzleFunctions::getWeigthedNumberOfMisplacedTiles);
			SearchAgent<Object, EightPuzzleBoard, Action> agent = new SearchAgent<>(problem, search);
			printActions(agent.getActions());
			printInstrumentation(agent.getInstrumentation());
		} catch (Exception e) {
	...
	private static void eightPuzzleAStarWeigthedNonConsistentDemo() {
		System.out.println("\nEightPuzzleDemo AStar Search (ManhattanWeigthedHeursitic)");
		try {
			Problem<EightPuzzleBoard, Action> problem = new BidirectionalEightPuzzleProblem(random1);
			SearchForActions<EightPuzzleBoard, Action> search = new AStarSearch<>
					(new GraphSearch<>(), EightPuzzleFunctions::getWeigthedNonConsistent);
			SearchAgent<Object, EightPuzzleBoard, Action> agent = new SearchAgent<>(problem, search);
			printActions(agent.getActions());
			printInstrumentation(agent.getInstrumentation());
		} catch (Exception e) {
